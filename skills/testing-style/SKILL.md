---
name: testing-style
description: Test conventions for JUnit 5 and Mockito: @ExtendWith(MockitoExtension.class) scaffolding, AssertJ assertThat and assertThatThrownBy, methodUnderTest_scenario_expectedBehavior naming, shared fixtures, per-test builders, and body formatting. Use when writing or changing tests.
license: MIT
---

<!-- Generated from rules/testing.md by build.py. Edit the rule file, not this file. -->
...
- **Test method naming**: `methodUnderTest_scenario_expectedBehavior`, with camelCase scenario and behavior segments separated by underscores. Examples: `parseAndPreviewCsv_emptyCsv_returnsError`, `delete_referencedByProgram_throwsException`, `validate_activeWithMissingStart_rejectsStartDateTime`. Read it as "method `X`, when `scenario`, returns/throws/rejects `Y`."
