---
name: testing-style
description: Test conventions for JUnit 5 and Mockito: @ExtendWith(MockitoExtension.class) scaffolding, AssertJ assertThat and assertThatThrownBy, methodUnderTestScenarioExpectedBehavior naming, shared fixtures, per-test builders, and body formatting. Use when writing or changing tests.
license: MIT
---
